    ...
    <tr >
        <td colspan="3" >
            <table id="encabezado3"  width="100%" >
                <tr>
                <td><strong>  <?php echo 'Razón Social:' ?> </strong> <?php echo strtoupper(strtoupper($factura->fac_nombre))?></td>
                <td></td>
                ...
                <tr>
                    <td><strong><?php echo 'Dirección:' ?> </strong><?php echo ucwords(strtoupper($factura->fac_direccion))?></td>
