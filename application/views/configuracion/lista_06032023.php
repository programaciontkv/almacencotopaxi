					...
					<table id="tbl_list" class="table table-bordered table-list table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="radio" name="precio_pro" id="precio_pro1" <?php echo $chk_p1?> value="0"> SI
									<input type="radio" name="precio_pro" id="precio_pro2" <?php echo $chk_p2?> value="1"> NO</td>
							</tr>
							<tr>
								<td>11</td>
								<?php
								...
								<td><input type="radio" name="chk_upt" id="chk_upt1" onclick="validar()" <?php echo $chk_p1?> value="0"> SI
									<input type="radio" name="chk_upt" id="chk_upt2" onclick="validar()" <?php echo $chk_p2?> value="1"> NO</td>
									<td ><input type="" <?php echo $hidden ?> id="cred_aut"  name="cred_aut" value="<?php echo $conf27->con_valor2?>"></td>
